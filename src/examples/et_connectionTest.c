...
/**
 * The purpose of this program is to connect, get a new event, fill and put the event, and disconnect.
 * This is done repeatedly in a cycle to try to find errors associated with connecting and disconnecting
 * from the ET system. Designed mainly to test remote/network connections.
 *
...
int main(int argc,char **argv) {
    ...
    int sendBufSize=0, recvBufSize=0, noDelay=0, noAllocFlag=0;
    ...
    while (1) {
        ...
        // OPEN ET SYSTEM AND ATTACH TO GC
